        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(SD.ProviderEndUser))
                    {
                        await _roleManager.CreateAsync(new IdentityRole(SD.ProviderEndUser));
                    }
                    ...
                    if (Input.IsAdmin)
                    {
                        ...
                        return RedirectToPage("/Users/IndexUser");
                    }
                    else
                    {
                        await _userManager.AddToRoleAsync(user, SD.ProviderEndUser);
