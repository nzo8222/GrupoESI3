...
namespace GrupoESIDataAccess.Migrations
{
    ...
    [Migration("20201009192347_quotationFkToTaskModel")]
    partial class quotationFkToTaskModel
    {
            ...
            modelBuilder.Entity("GrupoESIModels.Models.TaskModel", b =>
                {
                    ...
                    b.Property<Guid>("QuotationFk")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("QuotationFk");
