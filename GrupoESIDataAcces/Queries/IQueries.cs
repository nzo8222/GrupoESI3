...
namespace GrupoESIDataAccess.Queries
{
    public interface IQueries
    {
        ...
        EmployeeUser GetEmployeeIncludeQuotationLstEmployedByFirstOrDefaultEmployeeIdEqualsEmployeeId(string employeeId);
        ...
        Quotation GetQuotationIncludeOrderDetailsOrdersTasksListMaterialPicturesFirstOrDefault(Guid orderDetailsId);
